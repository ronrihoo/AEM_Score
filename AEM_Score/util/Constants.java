...
public class Constants {
    ...
    public static final int MAX_LETTERGRADE_QUANTITY = 5;
    public static final int A_MAX = 99;
    public static final int B_MAX = 89;
    public static final int C_MAX = 79;
    public static final int D_MAX = 69;
